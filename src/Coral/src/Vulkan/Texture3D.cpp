...
//#include <string>
//
//module RenderLib.OpenGL.Texture3D;
//
...
//
//bool
//Texture3DImpl::init(Context* context, const RenderLib::Texture3DConfig& config)
//{
//	if (!context)
//	{
//		return false;
...
//	glTextureStorage3D(mHandle, 1, internalFormat, config.width, config.height, config.depth);
//	if (config.data)
//	{
//		auto alignment = [&]
//		{
...
//		glTextureSubImage3D(mHandle, 0, 0, 0, 0, mWidth, mHeight, mDepth, format, type, config.data);
//	}
//	else
//	{
//		std::vector<uint8_t> zeros(mWidth * mHeight * mDepth * sizeInBytes(mFormat), 0);
//
//		glPixelStorei(GL_PACK_ALIGNMENT, 1);
//		glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
//		glTextureSubImage3D(mHandle, 0, 0, 0, 0, mWidth, mHeight, mDepth, format, type, zeros.data());
//	}
//	mHasMipmaps = config.generateMips;
//
//	if (mHasMipmaps)
